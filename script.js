...
weatherStatus.innerText = 'Nublado'
...
aboutText2.innerHTML = 'O WeatherNow foi desenvolvido usando HTML, CSS e JavaScript. <br> Nele foi usado um metodo aonde não foi adicionado nenhum elemento dentro da tag "body" do HTML, todos os elementos desse site são criados através do JavaScript, ou seja, essa aplicação esta sendo renderizada totalmente em JavaScript puro. <br><br> A aplicação conta com uma API de clima fornecida pela OpenWeather, no qual so é possivel fazer o uso dela com uma chave e ela precisa ser ativada<br><br><br><br>Code by : Charleston'
